...
import org.julio.gregorio.adidas.subscription.api.EmailController;
import org.julio.gregorio.adidas.subscription.api.JwtAuthenticationController;
...
public class SwaggerConfiguration {
	...
	public Docket ordersDocket() {
		...
		return new Docket(DocumentationType.SWAGGER_2).groupName(groupName).pathMapping("/").apiInfo(apiInfo)
				...
				.apis(includeOnly(SubscriptionController.class, NewsLetterController.class, EmailController.class,
