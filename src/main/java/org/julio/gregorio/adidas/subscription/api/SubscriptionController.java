...
public class SubscriptionController {
	...
	public ResponseEntity<Long> createSubscription(@ModelAttribute SubscriptionRequestDTO subscriptionRequestDTO) {
		log.debug("REST request received - createSubscription: {}", subscriptionRequestDTO);

		Long createdSubscriptionId = subscriptionService.createSubscription(subscriptionRequestDTO);
