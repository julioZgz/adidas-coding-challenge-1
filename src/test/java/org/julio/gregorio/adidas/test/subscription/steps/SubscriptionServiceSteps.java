...
public class SubscriptionServiceSteps {
	...
	public void i_create_subscription() throws Throwable {
		try {
			receivedResponse = subscriptionService.createSubscription(subscriptionRequestDTO);
		} catch (Exception e) {
			receivedException = e;
		}
	}
	...
	public void i_update_subscription() throws Throwable {
		try {
			subscriptionService.updateSubscription(requestedId, subscriptionRequestDTO);
		} catch (Exception e) {
			receivedException = e;
		}
	}
	...
	public void i_remove_subscription() throws Throwable {
		try {
			subscriptionService.removeSubscription(requestedId);
		} catch (Exception e) {
			receivedException = e;
		}
	}
